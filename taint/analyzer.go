...
func issueText(description string, sink Sink) string { _ = "STUB: not implemented"; return "" }
...
func newSinkID(sink Sink) sinkID { _ = "STUB: not implemented"; return *new(sinkID) }
